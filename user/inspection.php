...
$que = "SELECT * FROM vendors 
WHERE `pin` = '$pincode' 
AND `area` = '$NH' 
AND (`space` = 'Car guide' OR `space` = 'Car Inspection')"; 
...
<nav class="sidebar">
    ...
    <div class="table-container">
        <h3>Available Inspection Services :-</h3>
        <table class="contact-table" style="margin-right:30px;">
            ...
            <?php
              ...
              while($row = mysqli_fetch_assoc($result1)) { ?>
                ...
                <td><a href="./operate/procress_inspect.php?uid=<?php echo $row['id']; ?>"><button type="button" class="action-btn" style="background-color:green">BOOK NOW</button></a></td>
