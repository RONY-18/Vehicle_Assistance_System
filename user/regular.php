...
WHERE `pin` = '$pincode' 
AND `area` = '$NH' 
AND (`space` = 'Maintenance' OR `space` = 'Regular Service')"; 
...
<nav class="sidebar">
    ...
    <div class="table-container">
        <h3>Available Regular Service :-</h3>
        <table class="contact-table" style="margin-right:30px;">
            ...
            <?php
              ...
              while($row = mysqli_fetch_assoc($result1)) { ?>
                ...
                <td><a href="./operate/procress_regular.php?uid=<?php echo $row['id']; ?>"><button type="button" class="action-btn" style="background-color:green">BOOK NOW</button></a></td>
