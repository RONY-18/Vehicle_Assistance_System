...
$que = "SELECT * FROM `vendors` WHERE `pin` = '$pincode' AND `area` = '$NH' AND `towing` = 'Yes'";
        ...
        <table class="contact-table" style="margin-right:30px;">
            ...
            <?php
              ...
              while($row = mysqli_fetch_assoc($result1)) { ?>
                ...
                <td><a href="./operate/procress_towing.php?uid=<?php echo $row['id']; ?>"><button type="button" class="action-btn" style="background-color:green">CALL TOW-TRUCK</button></a></td>
