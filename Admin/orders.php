...
$dbname = "break_pass";
    ...
    <?php } ?>
<?php
                  $que1= "SELECT * FROM `requests` WHERE 1";
        ...
        <table class="contact-table" style="margin-right:30px;">
            ...
            <?php
              ...
              while($row = mysqli_fetch_assoc($result1)) { ?>
                ...
                <td><a href="./operations/update_ord.php?uid=<?php echo $row['id']; ?>"><button type="button" class="action-btn" style="background-color:#f57c00">Update</button></a></td>
                <td><a href="./operations/delete_ord.php ?uid=<?php echo $row['id'];?>"><button type="button" class="action-btn" style="background-color:red">Delete</button></a></td>
            </tr>
            <?php }?>
