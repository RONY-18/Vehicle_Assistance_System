...
$dbname = "break_pass";
    ...
    <?php } ?>
<?php
                  $que1= "SELECT * FROM `vendors` WHERE 1";
        ...
        <table class="contact-table" style="margin-right:30px;">
            ...
            <?php
              ...
              while($row = mysqli_fetch_assoc($result1)) { ?>
                ...
                <td> <?php  echo $row['towing']; ?> </td>
                <td> <?php  echo $row['pin']; ?> </td>
                <td> <?php  echo $row['charges']; ?> </td>
                <td> <?php  echo $row['created_at']; ?> </td>
                <td><a href="./operations/update_ven.php?uid=<?php echo $row['id']; ?>"><button type="button" class="action-btn" style="background-color:#f57c00">Update</button></a></td>
                <td><a href="./operations/delete_ven.php?uid=<?php echo $row['id'];?>"><button type="button" class="action-btn" style="background-color:red">Delete</button></a></td>
            </tr>
            <?php }?>
