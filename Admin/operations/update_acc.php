...
<html lang="en">
  ...
  <div id="main">
    <?php if(isset($_GET['uid'])) {
      ...
      $id=$_GET['uid'];
      $q4= "SELECT * FROM `accounts` WHERE `id` = '$id'";
  ...
  <form method="POST" idn ="<?php echo $id ?>">
        ...
        <div class="form-group">
             ...
             <input type="text" value ="<?php echo $row['password']; ?>" name ="uconf" id="phone" class="form-control" placeholder="Please enter your phone" aria-describedby="helpId" Required>
        ...
        if(isset($_POST['update'])){
          ...
          $q5= "UPDATE `accounts` SET `email`='$uemail',`password`='$uconf' WHERE `id`='$idn1';";
